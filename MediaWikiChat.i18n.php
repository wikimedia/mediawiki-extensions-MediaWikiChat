...
* $2 - the user who was kicked, no need GENDER',
	'log-show-hide-chat' => 'For [[Special:Log]].

This should be consistent with {{msg-mw|Log-name-chat}}.

Parameters:
* $1 - {{msg-mw|Show}} or {{msg-mw|Hide}}
{{Related|Log-show-hide}}',
	'log-name-privatechat' => 'This should be consistent with {{msg-mw|Log-show-hide-chat}}.',
...
This should be consistent with {{msg-mw|Log-name-privatechat}}.
...
$messages['ar'] = array(
	...
	'chat-change-preferences' => 'تعديل تفضيلاتك الخاصة بالدردشة', # Fuzzy
...
$messages['bn'] = array(
	...
	'log-show-hide-privatechat' => 'আড্ডার লগ $1', # Fuzzy
...
$messages['ce'] = array(
	...
	'chat-change-preferences' => 'Чатан гӀирс хийца', # Fuzzy
...
$messages['de'] = array(
	...
	'chat-change-preferences' => 'Chat-Einstellungen ändern (Vollbild und Sounds)',
	...
	'log-name-privatechat' => 'Privates Chat-Logbuch',
	'log-description-privatechat' => 'Private Nachrichten, die von der Erweiterung „MediaWikiChat“ versandt wurden.',
	'logentry-privatechat-send' => '$1 an $5: $4',
	'log-show-hide-privatechat' => 'Privates Chat-Logbuch $1',
	...
	'tog-chat-fullscreen' => 'Chat im Vollbildmodus verwenden (experimentell)',
	...
	'tog-chat-ping-joinleave' => 'Einen Sound abspielen, wenn Benutzer dem Chat beitreten oder es verlassen.',
	'prefs-chat' => 'Chat',
...
$messages['fa'] = array(
	...
	'chat-change-preferences' => 'اولویت‌های گفتگوی خود را تغییر دهید (تمام صفحه و صداها)',
	...
	'log-show-hide-chat' => '$1 سیاهه گفتگو',
	'log-name-privatechat' => 'سیاهه گفتگو خصوصی',
	'log-description-privatechat' => 'پیام‌های خصوصی ارسال شده توسط گفتگو مدیاویکی',
	'logentry-privatechat-send' => '$1 به $5ː $4',
	'log-show-hide-privatechat' => '$1 سیاهه گفتگو خصوصی',
	...
	'tog-chat-fullscreen' => 'در حالت تمتم صفحه از گفتگو استفاده کنید (تجربی)',
...
$messages['fr'] = array(
	...
	'chat-change-preferences' => 'Modifier vos préférences de discussion (plein écran et sons)',
	...
	'log-show-hide-chat' => '$1 le journal de discussion',
	'log-name-privatechat' => 'Journal de discussion privé',
	'log-description-privatechat' => 'Messages privés envoyés par mediaWikiChat',
	'logentry-privatechat-send' => '$1 à $5 : $4',
	'log-show-hide-privatechat' => '$1 le journal de discussion privé',
	...
	'tog-chat-fullscreen' => 'Utiliser la discussion en mode plein écran (expérimental)',
	...
	'tog-chat-ping-joinleave' => 'Jouer un son quand des utilisateurs rejoignent ou quittent la discussion',
...
$messages['hi'] = array(
	...
	'chat-flood' => 'आप इतनी तेज़ी से सन्देश नहीं भेज सकते। कृपया प्रतीक्षा करें।',
	'chat-too-long' => 'वह संदेश बहुत लंबा था, कृपया इससे छोटा संदेश भेजें।',
	'chat-change-preferences' => 'अपनी चैट वरीयताएँ बदलें', # Fuzzy
...
$messages['it'] = array(
	'chat' => 'Chat',
	'chat-desc' => 'Fornisce un client e un server per la chat leggeri',
	'chat-type-your-message' => 'Scrivi il tuo messaggio',
	'chat-type-your-private-message' => 'Scrivi il tuo messaggio privato',
	'chat-no-other-users' => 'Non ci sono altri utenti in chat',
	'chat-blocked-from-chat' => 'Sei stato bloccato in questa chat.',
	'chat-not-allowed' => "Non ti è consentito in chat, prova a effettuare l'accesso prima.",
	'chat-sounds' => 'Riproduci i suoni',
	'chat-flood' => 'Non è possibile inviare messaggi così rapidamente, sei pregato di attendere prima di inviarne altri.',
	'chat-too-long' => 'Questo messaggio era troppo lungo, sei pregato di inviare un messaggio più breve.',
	'chat-just-now' => 'proprio ora',
	'chat-a-minute-ago' => 'un minuto fa',
	'chat-yesterday' => 'ieri',
	'chat-kick' => 'kick (espulsione)',
	'chat-block' => 'blocco',
	'chat-youve-been-kicked' => 'Sei {{GENDER:$2|stato espulso|stata epulsa}} da $1. Aggiorna la pagina per chattare.',
	'chat-you-kicked' => 'Hai {{GENDER:$2|espulso}} $1.',
	'chat-kicked' => '$1 {{GENDER:$3|ha espulso}} $2.',
	'chat-youve-been-blocked' => 'Sei {{GENDER:$2|stato bloccato|stata bloccata}} da $1.',
	'chat-you-blocked' => 'Hai {{GENDER:$2|bloccato}} $1.',
	'chat-blocked' => '$1 {{GENDER:$3|ha bloccato}} $2.',
	'chat-you-unblocked' => 'Hai {{GENDER:$2|sbloccato}} $1.',
	'chat-unblocked' => '$1 {{GENDER:$3|ha sbloccato}} $2.',
	'chat-joined' => '$1 è {{GENDER:$2|entrato|entrata}} in chat.',
	'chat-left' => '$1 è {{GENDER:$2|uscito|uscita}} dalla chat.',
	'chat-private-message' => 'clicca per inviare un messaggio privato',
	'chat-user-is-moderator' => 'Questo utente è {{GENDER:$1|un moderatore|una moderatrice}}',
	'chat-you-are-moderator' => 'Sei {{GENDER:$1|un moderatore|una moderatrice}}',
	'chat-topic' => 'Benvenuto alla chat di {{SITENAME}}. ([[Special:Log/chat|log della chat]])',
	'chat-change-preferences' => 'Cambia le tue preferenze di chat (schermo intero e suoni)',
	'chat-sidebar-online' => 'Utenti online in chat:',
	'chat-sidebar-join' => 'Entra in chat',
	'chat-mod-image' => 'http://images.brickimedia.org/c/cb/Golden-minifigure.png',
	'log-name-chat' => 'Chat',
	'log-description-chat' => 'Messaggi inviati da MediaWikiChat, così come espulsioni utente',
	'logentry-chat-kick' => '$1 {{GENDER:$1|ha espulso}} $4',
	'log-show-hide-chat' => '$1 chat',
	'log-name-privatechat' => 'Chat privata',
	'log-description-privatechat' => 'Messaggi privati inviati da MediaWikiChat',
	'logentry-privatechat-send' => 'Da $1 a $5: $4',
	'log-show-hide-privatechat' => '$1 chat privata',
	'group-chatmod' => 'Moderatori della chat',
	'group-chatmod-member' => '{{GENDER:$1|moderatore della chat|moderatrice della chat}}',
	'grouppage-chatmod' => '{{ns:project}}:Moderatori della chat',
	'group-blockedfromchat' => 'Utenti bloccati dalla chat',
	'group-blockedfromchat-member' => '{{GENDER:$1|bloccato dalla chat|bloccata dalla chat}}',
	'grouppage-blockedfromchat' => '{{ns:project}}:Utenti bloccati dalla chat',
	'right-mediawikichat-chat' => 'Usa Speciale:Chat',
	'right-mediawikichat-modchat' => 'Blocca ed espelli (se abilitato) gli utenti da Special:Chat',
	'tog-chat-fullscreen' => 'Utilizza la chat in modalità a schermo intero (sperimentale)',
	'tog-chat-ping-mention' => 'Riprodurre un suono quando si ricevono menzioni',
	'tog-chat-ping-pm' => 'Riprodurre un suono quando si ricevono messaggi privati',
	'tog-chat-ping-message' => 'Riprodurre un suono quando si ricevono messaggi normali',
	'prefs-chat' => 'Chat',
);
...
$messages['ja'] = array(
	...
	'chat-change-preferences' => 'チャットの個人設定を変更 (全画面表示とサウンド)',
	'chat-sidebar-online' => 'チャットでオンラインの利用者:',
	'chat-sidebar-join' => 'チャットに入室',
	'chat-mod-image' => 'http://images.brickimedia.org/c/cb/Golden-minifigure.png',
	'log-name-chat' => 'チャット記録',
	'log-show-hide-chat' => 'チャット記録を$1',
	'log-name-privatechat' => '非公開チャット記録',
	'log-description-privatechat' => 'MediaWikiChat で送信された非公開メッセージ',
	'logentry-privatechat-send' => '$1 → $5: $4',
	'log-show-hide-privatechat' => '非公開チャット記録を$1',
...
$messages['ko'] = array(
	...
	'chat-topic' => '{{SITENAME}} 채팅에 오신 것을 환영합니다. ([[Special:Log/chat|채팅 기록]])',
	'chat-change-preferences' => '채팅 설정 바꾸기', # Fuzzy
...
$messages['lb'] = array(
	...
	'chat-change-preferences' => 'Ännert Är Chat-Astellungen (Fullscreen an Toun)',
	'chat-mod-image' => 'http://images.brickimedia.org/c/cb/Golden-minifigure.png',
	'log-description-privatechat' => 'Privat Messagen déi iwwer MediaWikiChat verschéckt goufen',
	'logentry-privatechat-send' => '$1 fir $5: $4',
...
$messages['mg'] = array(
	...
	'chat-change-preferences' => "Hanova ny safidin'ny resaka mifantana", # Fuzzy
...
$messages['mk'] = array(
	...
	'chat-type-your-private-message' => 'Внесете ја вашата лична порака',
	...
	'chat-private-message' => 'стиснете за да испратите лична порака',
	...
	'chat-change-preferences' => 'Измени нагодувања на разговорот (цел екран и звуци)',
	...
	'tog-chat-fullscreen' => 'Користи го разговорот во целоекрански режим (експериментално)',
	...
	'tog-chat-ping-joinleave' => 'Пушти звук кога корисниците доаѓаат или го напуштаат разговорот',
	'prefs-chat' => 'Разговор',
...
चॅट करण्यास या पानास तरोताजे करा',
	...
	'chat-change-preferences' => 'आपल्या गप्पागोष्टींचा पसंतीक्रम बदला', # Fuzzy
	...
	'log-show-hide-privatechat' => '$1 चॅट नोंदी', # Fuzzy
...
$messages['nl'] = array(
	...
	'tog-chat-ping-mention' => 'Een geluid afspelen bij vermeldingen',
	'tog-chat-ping-pm' => 'Een geluid afspelen bij het ontvangen van persoonlijke berichten',
	'tog-chat-ping-message' => 'Een geluid afspelen bij het ontvangen van normale berichten',
	'prefs-chat' => 'Chat',
);
...
$messages['pl'] = array(
	...
	'chat-sounds' => 'Odtwarzaj dźwięki',
	'chat-flood' => 'Nie możesz wysyłać wiadomości tak szybko, poczekaj zanim wyślesz ich więcej.',
	'chat-too-long' => 'Ta wiadomość była zbyt długa, wyślij krótszą.',
	...
	'chat-change-preferences' => 'Zmień ustawienia czatu (pełny ekran oraz dźwięki)',
	...
	'tog-chat-fullscreen' => 'Używaj czatu w trybie pełnego ekranu (funkcja eksperymentalna)',
	'tog-chat-ping-mention' => 'Odtwórz dźwięk kiedy zostaniesz wspomniany',
	'tog-chat-ping-pm' => 'Odtwórz dźwięk kiedy otrzymasz prywatną wiadomość',
	'tog-chat-ping-message' => 'Odtwórz dźwięk kiedy otrzymasz wiadomość',
	'prefs-chat' => 'Czat',
);
...
$messages['ps'] = array(
	...
	'chat-private-message' => '(شخصي پيغام)', # Fuzzy
	...
	'log-show-hide-privatechat' => 'بانډار يادښت $1', # Fuzzy
...
$messages['ru'] = array(
	...
	'chat-change-preferences' => 'Изменить настройки чата (полноэкранный режим и звуки)',
	...
	'log-name-privatechat' => 'Журнал частной переписки в чате',
	'log-description-privatechat' => 'Частные сообщения, отправленные через MediaWikiChat',
	'logentry-privatechat-send' => '$1 отправил $5: $4',
	'log-show-hide-privatechat' => '$1 журнал частной переписки в чате',
	...
	'tog-chat-fullscreen' => 'Использовать чат в полноэкранном режиме (экспериментальная функция)',
	...
	'tog-chat-ping-joinleave' => 'Проигрывать звук, когда участники присоединяются или покидают чат',
	'prefs-chat' => 'Чат',
...
$messages['sco'] = array(
	...
	'chat-too-long' => 'That message wis ower lang, please send ae shorter message. (Or twa).',
	'chat-private-message' => 'clap tae private message',
	'chat-user-is-moderator' => 'This uiser {{GENDER:$1|is}} ae moderator',
	'chat-you-are-moderator' => 'Ye {{GENDER:$1|ar}} ae moderater',
	'chat-change-preferences' => 'Chynge yer tauk preeferances (fulscreen n soonds)',
	'log-show-hide-chat' => '$1 chat log',
	'log-name-privatechat' => 'The preevate tauk log',
	'log-description-privatechat' => 'Private messages sent bi MediaWikiChat',
	'logentry-privatechat-send' => '$1 til $5: $4',
	'tog-chat-fullscreen' => 'Uise The tauk in the fulscreen mode (expereemental)',
	'tog-chat-ping-mention' => 'Pley ae soond oan receevin mentions',
	...
	'tog-chat-ping-joinleave' => 'Pley ae soond whan uisers jyn or lea the tauk',
	'prefs-chat' => 'The Tauk',
...
$messages['si'] = array(
	...
	'chat-sounds' => 'ශබ්ද වාදනය කරන්න',
	'chat-flood' => 'ඔබට මේ තරම් වේගයෙන් පණිවිඩ යැවිය නොහැක,කරුණාකර තවත් යවීමට පෙර මඳක් ඉවසන්න.',
	'tog-chat-ping-pm' => 'ලැබෙන පුද්ගලික පනිවිඩ සඳහා ශබ්දයක් වාදනය කරන්න.',
	'prefs-chat' => 'චැට්',
);
...
$messages['sr-ec'] = array(
	...
	'chat-change-preferences' => 'Промени поставке ћаскања', # Fuzzy
...
$messages['sv'] = array(
	...
	'chat-flood' => 'Du kan inte skicka meddelanden så snabbt, var god vänta innan du skickar fler.',
	...
	'chat-change-preferences' => 'Ändra dina chattinställningar (helskärm och ljud)',
	...
	'log-name-privatechat' => 'Privat chattlogg',
	'log-description-privatechat' => 'Privata meddelanden som skickas av MediaWikiChat',
	'logentry-privatechat-send' => '$1 till $5: $4',
	'log-show-hide-privatechat' => '$1 privat chattlogg',
	...
	'tog-chat-fullscreen' => 'Använd chatt i helskärmsläge (experimentell)',
 ...
 */
$messages['te'] = array(
	'chat-sounds' => 'శబ్దాలను వినిపించు',
	'chat-flood' => 'అంత వేగంగా సందేశాలు పంపడం కుదరదు. మరిన్ని పంపేముందు కాస్త ఆగండి.',
	...
	'chat-user-is-moderator' => 'ఈ వాడుకరి {{GENDER:$1|ఓ పరిశీలకుడు|ఓ పరిశీలకురాలు}}',
	'chat-you-are-moderator' => 'మీరు {{GENDER:$1|ఓ పరిశీలకులు}}',
	'chat-change-preferences' => 'మీ మాటామంతీ ప్రాధాన్యతలని మార్చుకోండి', # Fuzzy
	'tog-chat-ping-pm' => 'వ్యక్తిగత సందేశాలు వచ్చినప్పుడు ఓ శబ్దం చేయి.',
	'tog-chat-ping-message' => 'సాధారణ సందేశాలు వచ్చినప్పుడు శబ్దం చేయి.',
	'prefs-chat' => 'మాటామంతి',
);
...
$messages['tr'] = array(
	...
	'chat-private-message' => '(özel mesaj)', # Fuzzy
	...
	'log-show-hide-privatechat' => 'Sohbet günlüğünü $1', # Fuzzy
...
$messages['vi'] = array(
	...
	'chat-too-long' => 'Tin nhắn đó quá dài. Xin vui lòng gửi một tin nhắn ngắn hơn.',
...
$messages['zh-hant'] = array(
	...
	'chat-change-preferences' => '更新您的聊天設定（全屏與聲音）',
	...
	'log-show-hide-chat' => '$1聊天日誌',
	'log-name-privatechat' => '私人聊天日誌',
	'log-description-privatechat' => '私人資訊經由MediaWikiChat發送',
	'logentry-privatechat-send' => '$1至$5：$4',
	'log-show-hide-privatechat' => '$1私人聊天日誌',
	'group-chatmod' => '聊天版主',
	'group-chatmod-member' => '{{GENDER:$1|聊天版主}}',
	'grouppage-chatmod' => '{{ns:project}}:聊天版主',
	'group-blockedfromchat' => '被阻止聊天的用户',
	...
	'right-mediawikichat-chat' => '使用Special:Chat',
	'tog-chat-ping-mention' => '接收提及時播放一部分聲音',
